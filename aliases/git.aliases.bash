...
alias gco67='git checkout 6.7/master && gpl'
alias gco68='git checkout 6.8/master && gpl'
alias gco69='git checkout 6.9/master && gpl'
alias gco70='git checkout 7.0/master && gpl'
alias gco71='git checkout 7.0/master && gpl'
